...
class COVID:
    ...
    def run(self):
        ...
        val_dataframe = self.validation
        train_dataframe = self.train

        train_ds = self._get_dataset(train_dataframe)
        val_ds = self._get_dataset(val_dataframe)
        train_ds = train_ds.batch(self.batch)
        val_ds = val_ds.batch(self.batch)
